...
AddEventHandler('TRS-Characters:Client:PlayerLoaded', function(CharID)
	trsID = CharID

	-- print("MTV: TRS Loaded")
	-- print("MTV: Your TRSID is: " .. trsID)

	TriggerServerEvent('t1ger_shops:fetchPlyShops', trsID)
	TriggerServerEvent('t1ger_shops:fetchShopShelves')
end)
